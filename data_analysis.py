...
features_lists_dict['processed continuous'] = continuous_additial

correlations_dict = {}
corr = work_df[discrete_initial + ['churn']].corr()
fig, ax = plt.subplots()
ax = sns.heatmap(corr, cmap="Blues", annot=True)
correlations_dict['initial discrete features'] = fig

corr = work_df[continuous_additial + ['churn']].corr()
fig, ax = plt.subplots()
ax = sns.heatmap(corr, cmap="Blues", annot=True)
correlations_dict['normalized continuous features'] = fig
...
if __name__ == "__main__":
    print(list(correlations_dict.keys()))
